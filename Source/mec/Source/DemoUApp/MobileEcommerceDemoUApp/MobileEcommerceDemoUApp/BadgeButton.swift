...
extension UIBarButtonItem {
    ...
    convenience init(badge: String?, title: String, target: AnyObject?, action: Selector) {
        ...
        let bundle = Bundle(identifier: "org.cocoapods.MobileEcommerceDemoUApp")
        ...
        button.addConstraint(NSLayoutConstraint(item: badgeLabel, attribute: .top, relatedBy: .equal, toItem: button, attribute: .top, multiplier: 1, constant: -10))
