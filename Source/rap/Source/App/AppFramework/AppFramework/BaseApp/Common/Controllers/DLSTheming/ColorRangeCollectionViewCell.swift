...
class ColorRangeCollectionViewCell: UICollectionViewCell {
    ...
    func configureCellWithSetting(_ collectionViewSetting: CollectionViewSetting,
        ...
        self.imageView.image = UIImage(named: Constants.THEME_SETTING_CHECK_ICON)
...
struct CollectionViewSetting {
    ...
    let cellIdentifier: String = Constants.COLOR_RANGE_COLLECTION_VIEW_CELL
    ...
    var accentColors: [UIDColorRange]?
}
