...
class ThemeSettingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.errorMessageCloseButton.titleLabel?.font = UIFont.philipsIconFont(withSize: closeIconSize)
        self.errorMessageCloseButton.setTitle(PUIIcon.close(), for: .normal)
...
extension ThemeSettingViewController {
    fileprivate func settingForCollectionView(_ collectionView: UICollectionView) -> CollectionViewSetting {
        ...
        case self.colorRangeCollectionView:
            ...
            collectionViewSetting.selectedIndex = collectionViewSetting.colorRanges.index { $0 == defaultTheme?.colorRange }!
        case self.tonalRangeCollectionView:
            self.settingForTonalRangeCollectionView(collectionViewSetting: &collectionViewSetting)
            collectionViewSetting.selectedIndex = collectionViewSetting.tonalRanges.index { $0 == defaultTheme?.tonalRange }!
        case self.navigationCollectionView:
            ...
            collectionViewSetting.selectedIndex =
                collectionViewSetting.tonalRanges.index { $0 == defaultTheme?.navigationTonalRange }!
