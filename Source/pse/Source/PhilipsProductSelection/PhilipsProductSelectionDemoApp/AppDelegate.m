...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self.appInfra.tagging setPrivacyConsent:AIATPrivacyStatusUnknown];
    
    UIDTheme *theme = [[UIDTheme alloc] initWithThemeConfiguration:[[UIDThemeConfiguration alloc] initWithColorRange:UIDColorRangeBlue tonalRange:UIDTonalRangeUltraLight]];
