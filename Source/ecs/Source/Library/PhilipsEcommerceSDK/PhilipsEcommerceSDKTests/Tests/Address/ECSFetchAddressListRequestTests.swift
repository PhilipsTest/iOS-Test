...
class ECSFetchAddressListRequestTests: XCTestCase {
    ...
    func testFetchAddressRequestMethod() {
        ...
        let testMicro = ECSFetchAddressMicroServices()
        testMicro.fetchSavedAddressList { (_, _) in }
    ...
    func testFetchAddressRequestMethodError() {
        mockRestClient.responseData = ECSTestUtility.getResponseFrom(jsonFile: "testSetDeliveryAddressSuccess")
        mockAppInfra.restClient = mockRestClient
