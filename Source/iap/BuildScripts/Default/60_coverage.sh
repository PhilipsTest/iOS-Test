...
then
(
    coverageFileDir="$BUILD_DIR/Build/Intermediates/CodeCoverage/${TEST_TARGET}/Intermediates/$APP_NAME.build/Debug-iphonesimulator/${TEST_TARGET}.build/Objects-normal/i386"
