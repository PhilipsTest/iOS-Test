...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    AppInfraMicroAppDependencies *objAIMicroAppDependency = [[AppInfraMicroAppDependencies alloc]init];
    objAIMicroAppDependency.appInfra = [AIAppInfra buildAppInfraWithBlock:nil];
    
    self.objAppInfraMicroAppInterface = [[AppInfraMicroAppInterface alloc] initWithDependencies:objAIMicroAppDependency andSettings:nil];
